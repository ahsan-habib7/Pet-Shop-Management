...
<body>
    <div class="petlist-section">
        <h2>Pet List</h2>
        <div class="petlist">
            <button class="round-button left-button" onclick="scrollPetlistLeft()">&#x276E;</button>
            <div class="petlist-container">
                <div class="petlist-items">
                    <?php while($row = mysqli_fetch_assoc($all_product)){  ?>
                    <div class="petlist-item" >
                        ...
                        <form action="CustomerDashboard.php#pets" method="POST">
            ...
            <button class="round-button right-button" onclick="scrollPetlistRight()">&#x276F;</button>
        </div>
        <div class="shop-all-link">
        <a href="petProduct_view.php">Shop more <i class="fa-solid fa-arrow-right"></i></a>
        </div>
    </div>
